...
use TK\GitHubWebhook\Model\PullRequest\PullRequestAction;
use TK\GitHubWebhook\Model\PullRequest\PullRequestChanges;
...
class PullRequestEvent extends AbstractEvent
{
    ...
    public PullRequestAction $action;
    public int $number;
    ...
    public PullRequestChanges|null $changes;
    ...
    public static function fromArray(array $data): PullRequestEvent
    {
        ...
        $instance->action = PullRequestAction::from($data["action"]);
        ...
        $instance->changes = Util::getArgSafe($data, "changes", PullRequestChanges::fromArray(...));
